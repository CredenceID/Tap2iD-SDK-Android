...
- Follow the [SDK Onboarding Guide: Portal Registration & Key Generation](https://github.com/CredenceID/Tap2iD-SDK-Android/wiki/SDK-Onboarding-Guide:-Verify-with-Credence-Portal-Registration-&-Key-Generation#step-2---generate-sdk-key) to get started.
